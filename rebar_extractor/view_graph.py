...
from core.topology import ConnectedComponent, TopologyGraph
from core.canonical import CanonicalNode
from core.geometry import LineEntity, ArcEntity, PolylineEntity
...
# Recognition type colours
TYPE_COLORS = {
    "straight_bar":       "#00E5FF",   # cyan
    "l_bar":              "#00FF88",   # green
    "u_bar":              "#88FF00",   # lime
    "stirrup":            "#FFD700",   # gold
    "branch":             "#FF8800",   # orange
    "dimension":          "#555577",   # muted purple
    "symbol":             "#884444",   # muted red
    "structural_outline": "#445555",   # muted teal
    "unknown":            "#333344",   # very dim
}

BG_COLOR   = "#0D0D0D"
GEO_COLOR  = "#1E1E2E"
SEL_COLOR  = "#FFFFFF"
UNSEL_COLOR = None  # will use TYPE_COLORS
BBOX_COLOR = "#FF8800"
TEXT_COLOR = "#CCCCCC"
